...
if __name__ == '__main__':
    ...
    p.model.add_design_var('receiver.s_INS',lower = 0.05,upper = 0.25, units='m', scaler= 10)
    p.model.add_design_var('receiver.L',lower = 0.02,upper = 0.1, units='m', scaler= 1000)
    p.model.add_design_var('receiver.Mass_Flow', lower = 0.0002, upper = 0.001, units='kg/s', scaler=100000)
