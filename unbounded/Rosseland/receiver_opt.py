...
if __name__ == '__main__':
    ...
    # p.driver = om.ScipyOptimizeDriver(debug_print = debug_print, optimizer='SLSQP', tol=1e-7)
    p.driver = om.ScipyOptimizeDriver(debug_print = debug_print, optimizer=optimizer, tol=tol)
    ...
    p.model.add_design_var('receiver.s_SiC',lower = 0.004, upper = 0.02, units='m',scaler= 1000)
    p.model.add_design_var('receiver.s_RPC',lower = 0.005, upper = 0.025, units='m', scaler= 1000)
    p.model.add_design_var('receiver.s_INS',lower = 0.05,upper = 0.15, units='m', scaler= 1)
    p.model.add_design_var('receiver.L',lower = 0.02,upper = 0.07, units='m', scaler= 1000)
    p.model.add_design_var('receiver.Mass_Flow', lower = 0.0004, upper = 0.0007, units='kg/s', scaler=10000)
    ...
    p.model.add_constraint('receiver.Volume',lower=0.002, upper=0.003721609197258809, units='m**3' ,scaler=10000)
