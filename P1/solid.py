...
@author: tufan
finite different solver for P1 method
"""
...
class solid(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output('T_RPC_CAV', shape=(1,self.options['disc_z']), desc='Temperature distribution of RPC-CAV', units='K')
        self.add_output('T_RPC_INS', shape=(1,self.options['disc_z']), desc='Temperature distribution of RPC-CAV', units='K')
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['T_RPC_CAV'] = T_RPC_CAV = T_new[bound1-1,1:Nz-1]
        outputs['T_RPC_INS'] = T_RPC_INS = T_new[bound2-1,1:Nz-1]
